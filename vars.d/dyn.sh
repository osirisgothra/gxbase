#
# /usr/local/gxbase/vars.d/dyn.sh
#   
#   Dynamic Variables (dynamic/addto/rmfrm/etc)
# 
# Author:
...
# Report any bugs to <bugs@paradisim.tk> or visit our FAQ on our website.
	#
	echo -e "$(abscol 33)dynamic variables (dyn/addto/rmfrm/etc)"

	## TODO: by march/april 2014: finish me
	##       i need a manager!
